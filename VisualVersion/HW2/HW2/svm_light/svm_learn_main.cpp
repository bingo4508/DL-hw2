...
char modelfile6[200];         /* file for resulting classifier */
...
{  
  ...
  read_input_parameters(argc,argv,docfile,modelfile6,restartfile,&verbosity,
			&learn_parm,&kernel_parm);
...
void read_input_parameters(int argc,char *argv[],char *docfile,char *modelfile6,
